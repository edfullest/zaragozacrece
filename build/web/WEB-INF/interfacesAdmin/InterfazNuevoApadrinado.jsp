        ...
        <c:when test="${sessionScope.goodlogin}">
                    ...
                    <ul class="sky-mega-menu">
                        ...
                        <li aria-haspopup="true">
                            ...
                            <div class="grid-container3">
                                <ul>
                                    <li>
                                        <a href="#"><i class="fa fa-plus-circle"></i>Añadir Apadrinado</a>
                                    </li>
                                    <li>
            ...
            <div class="body">
                <form action="apadrinados" method="post" id="sky-form" class="sky-form" >
                    <header>Llena los siguientes recuadros para añadir un apadrinado</header>
                                                          
                    <fieldset>					
                        <div class="row">
                            <section class="col col-5">
                                <label class="label">Nombre Completo del Apadrinado</label>
                                <label class="input">
                        ...
                        <input type="hidden" name="tipo" value="nuevoApadrinado">
                         ...
                         <c:choose>
                                    <c:when test="${exito}">
                                        <b><font color="green">Listo! Se ha añadido exitosamente!</font></b>
                                        </c:when>
                         </c:choose> 
                    ...
                    <footer>
                        <button type="submit" class="button">Añadir Apadrinado</button>
                    </footer>
            </form>
        ...
        $(function()
        {
            ...
            $("#sky-form").validate(
                ...
                messages:
                    ...
                    comunidad:
                            {
                                required: 'Introduce la comunidad del apadrinado',
                    },
