                                          ...
                                          <body class="bg-blue">
                                              <div class="body">
                                                  <form action="ControlNuevoPadrino" method="get" id="sky-form" class="sky-form" >
                                                      <header><i class ="fa fa-warning"></i> Lo sentimos, <b> ${correo} </b> no puso correo para apadrinar con alguien </header>
                                               
                                                      <fieldset>
                                                          <p> Esa persona se registró para como único padrino. Habla con él si cometió un error.</p>
