                    ...
                    <div class="sky-tabs sky-tabs-pos-top-left sky-tabs-response-to-icons">
                        <div class="textbox">
                            <section>
                                ...
                                <p>Este apartado es para asignar pagos a padrinos que quieren apadrinar SOLOS. Sólo procede si se pagó 750 pesos, de lo contrario ve a "Nuevo pago de pareja" bajo "Parejas"</p>
                            </section>
                        </div>
                    </div>
                    <div class="component">
                        ...
                        <table id="tabla">
                            ...
                            <c:forEach items="${padrinos}" var="item" >
                                <tr>
                                    <td><c:out value="${item.idPadrino}"/>
                                    </td>
                                    <td><c:out value="${item.nombreCompleto}"/>
                                    </td>

                                    <td><c:out value="${item.correo}"/>
                                    </td>
                                    
                                    <td><c:out value="${item.celular}"/>
                                    </td>
                                    
                                    <td><a href="ControlCargarPagos?tipo=redirigirCrearPago&idPadrino=${item.idPadrino}&correo=${item.correo}&nombreCompleto=${item.nombreCompleto}">
                                            <button type="button" class="button-table"><i class="fa fa-user-plus"></i> Nuevo Pago</button></a></td>
                            ...
                            <nav role="navigation"> 
                                <ul class="cd-pagination">
                                    ...
                                    <c:if test="${paginaActual != 1}">
                                        <li><a href="ControlCargarPagos?tipo=cargarTodosPadrinados&paginaActual=${paginaActual - 1}">Anterior</a></li>
                                        </c:if>
                                    ...
                                    <c:forEach begin="1" end="${numPaginas}" var="i">
                                        <c:choose>
                                            <c:when test="${paginaActual eq i}">
                                                ...
                                                <c:otherwise>
                                                <li><a href="ControlCargarPagos?tipo=cargarTodosPadrinados&paginaActual=${i}">${i}</a></li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                    
                                    <c:if test="${paginaActual != numPaginas}">
                                        <li><a href="ControlCargarPagos?tipo=cargarTodosPadrinados&paginaActual=${paginaActual + 1}">Siguiente</a></li>
                                        </c:if>
