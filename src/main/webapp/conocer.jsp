                                ...
                                <ul>
                                    <li class="sky-tab-content-1">
                                        <div class="typography">
                                            <h1>Acerca de nosotros</h1> Creciendo con Zaragoza es un grupo formado por estudiantes del Tecnológico de Monterrey. En él se busca el desarrollo integral de las comunidades alejadas del municipio de General Zaragoza, en Nuevo León.
                                            <br>
                                            ...
                                            <br>
                                            <br> 1) Salud y Nutrición: Lograr el desarrollo y crecimiento integral en los niños y brindar una mejor calidad de vida para adultos mayores, a través de la elaboración de NutreTec y VidaTec. Complementos alimenticios que aportan los nutrientes necesarios para el desarrollo físico y mental de cada etapa, respectivamente.
                                            <br>
                                            <br> 2) Educación: Un programa integral y compensatorio de educación que combata el analfabetismo y fomente una educación de calidad, a través del trabajo conjunto con CONAFE. Mediante la elaboración de manuales y planes educativos que faciliten la enseñanza en las escuelas rurales.
                                            <br>
                                            <br> 3) Apoyo Económico: Un programa que busca satisfacer algunas de las necesidades más básicas de las comunidades, como lo son el alimento y el vestido. Esto con la finalidad de reducir costos de vida de tal manera que se refleje en un crecimiento en la economía local. Así mismo, programas anexos que buscan la creación de sistemas económicos que proporcionen empleo y flujo de bienes entre las comunidades y el resto de la sociedad.
                                    ...
                                    <li class="sky-tab-content-3">
                                        <div class="typography">
                                            <h1>¿Cómo puedo ayudar?</h1> Existen varias maneras en que nos puedas apoyar para continuar llevando a cabo el proyecto. Una de éstas es: apadrinando a un niño o adulto mayor. Otra es por medio de la donación de ropa, comida (no perecedera), juguetes, libros escolares de nivel básico o medio, libros recreativos y/o material escolar, procurando que todos los objetos estén en buen estado.
                                            <br> Si tienes alguna duda o comentario, nos puedes mandar un correo a: proyecto.ccz@gmail.com y te contestaremos lo más rápido que podamos.
                                            <br> Con tu apoyo, se puede mejorar la calidad de vida de muchas personas.
