                                                  ...
                                                  <form action="ControlNuevoPadrino" method="get" id="sky-form" class="sky-form" >
                                                      ...
                                                      <input type="hidden" name="tipoMensaje" value="MatchError">
                                                          ...
                                                          <fieldset>
                                                              ...
                                                              <input type="hidden" name="correo2" value=${correo2}>
            
                                                          <p> </p>
                                                          
                                                      </fieldset>
                                                       <footer>  
                                                              <button type="submit" name="boton" value="apadrina" class="button">Apadrinar con ${correo}</button>
                                                              <button type="submit" name="boton" value="regresa" class="return-button">Regresar</button>
                                                      </footer>
