                    ...
                    <body class="bg-blue">
                        <div class="body">
                            <form action="ControlNuevoPadrino" method="get" id="sky-form" class="sky-form" >
                                <header><i class ="fa fa-check"></i> Excelente! Ya puedes apadrinar un niño! </header>
                                <fieldset>
                                    <p> Para apadrinar un niño, tendrás que primero pagar. Esto se puede hacer en tu cuenta, seleccionando la opción "Apadrina solo" del menú lateral</p>
