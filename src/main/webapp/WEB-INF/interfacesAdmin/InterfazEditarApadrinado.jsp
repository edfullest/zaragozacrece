        ...
        <c:when test="${sessionScope.goodlogin}">
            <body class="bg-cyan">
               ...
               <c:when test="${exito eq 'true'}">
                   <br>
                   <b><font color="white">Listo! Se ha editado exitosamente </font></b>
                   </c:when>
               </c:choose> 
                           ...
                           <tr>
                               ...
                               <c:choose>
                                   ...
                                   <c:otherwise>
                                       ...
                                       <td><a href="apadrinados?tipo=${"redirigirEditarApadrinado"}&idApadrinado=${item.idApadrinado}&nombreCompleto=${item.nombreCompleto}&comunidad=${item.comunidad}">
                                               <button type="button" class="button-table">Editar</button></a></td>
                   ...
                   <nav role="navigation"> 
                       <ul class="cd-pagination">
                           ...
                           <c:if test="${paginaActual != 1}">
                               <li><a href="apadrinados?tipo=${"editarApadrinado"}&paginaActual=${paginaActual - 1}">Anterior</a></li>
                               </c:if>
                           ...
                           <c:forEach begin="1" end="${numPaginas}" var="i">
                               <c:choose>
                                   <c:when test="${paginaActual eq i}">
                                       ...
                                       <c:otherwise>
                                       <li><a href="apadrinados?tipo=${"editarApadrinado"}&paginaActual=${i}">${i}</a></li>
                                       </c:otherwise>
                                   </c:choose>
                               </c:forEach>
                                   
                           <c:if test="${paginaActual != numPaginas}">
                               <li><a href="apadrinados?tipo=${"editarApadrinado"}&paginaActual=${paginaActual + 1}">Siguiente</a></li>
                               </c:if>
