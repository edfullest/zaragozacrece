                    ...
                    <div class="component">
                        ...
                        <table id="tabla">
                            ...
                            <c:forEach items="${pagos}" var="item" >
                                <tr>
                                    <td><c:out value="${item.idPagoPareja}"/>
                                    ...
                                    <td><c:out value="${item.fechaPago1}"/>
                                    </td>
                                    
                                    <td><c:out value="${item.fechaPago2}"/></td>
                                    
                                    <td><a href="cargarPagosParejas?tipo=redirigirAsignar&idPagoPareja=${item.idPagoPareja}&idPareja=${item.idPareja}&fechaPago1=${item.fechaPago1}$fechaPago2=${item.fechaPago2}">
                            ...
                            <nav role="navigation"> 
                                <ul class="cd-pagination">
                                    ...
                                    <c:if test="${paginaActual != 1}">
                                        <li><a href="cargarPagosParejas?tipo=cargarPagos&paginaActual=${paginaActual - 1}">Anterior</a></li>
                                        </c:if>
                                    ...
                                    <c:forEach begin="1" end="${numPaginas}" var="i">
                                        <c:choose>
                                            <c:when test="${paginaActual eq i}">
                                                ...
                                                <c:otherwise>
                                                <li><a href="cargarPagosParejas?tipo=cargarPagos&paginaActual=${i}">${i}</a></li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                    
                                    <c:if test="${paginaActual != numPaginas}">
                                        <li><a href="cargarPagosParejas?tipo=cargarPagos&paginaActual=${paginaActual + 1}">Siguiente</a></li>
                                        </c:if>
